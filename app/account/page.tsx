      ...
      <main className="mx-auto max-w-6xl px-6 pb-16 pt-28">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[380px_1fr]">
                  ...
                  return (
                    <button
                      ...
                      className={`w-full rounded-2xl border p-5 text-left transition-all ${
                        active
                          ? 'border-[#c9a84c] bg-[#16130b] shadow-[0_0_30px_rgba(201,168,76,0.12)]'
                          : 'border-[#23232d] bg-[#111118] hover:border-[#c9a84c]/50'
                      }`}
                    >
          ...
          <section>
            ...
            {!selectedScan ? (
              <div className="rounded-[28px] border border-[#23232d] bg-[#111118] p-8 text-[#8b8b99]">
                Select a scan to view the details.
              </div>
            ) : (
              <div className="space-y-6">
                <div className="rounded-[28px] border border-[#23232d] bg-[#111118] p-8">
                  <div className="flex items-center justify-between gap-4">
                    <h3 className="font-serif text-3xl font-bold text-[#f3efe7]">
                      Analysis
                    </h3>

                    <span className="rounded-full bg-[#c9a84c]/10 px-4 py-2 text-sm font-semibold text-[#c9a84c]">
                      {result?.overallRisk || 'Saved'}
                  ...
                  <p className="mt-6 leading-8 text-[#b4b4c2]">
                    {result?.summary || 'No summary saved.'}
                  </p>
                </div>
