        ...
        {!result ? (
          <div className="rounded-[32px] border border-[#23232d] bg-[#0f1014] p-6 shadow-[0_0_60px_rgba(201,168,76,0.08)]">
            ...
            <div className="mt-8 grid gap-6 lg:grid-cols-[340px_1fr]">
              ...
              <label className="group flex cursor-pointer flex-col items-center justify-center rounded-[28px] border border-dashed border-[#c9a84c]/40 bg-[#0b0b10] p-8 text-center transition-all hover:border-[#c9a84c] hover:bg-[#151515]">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="min-h-[360px] w-full rounded-[28px] border border-[#2a2a35] bg-[#09090c] p-6 text-[#f3efe7] outline-none transition-all placeholder:text-[#666674] focus:border-[#c9a84c]"
                />
            ...
            <div className="mt-12 flex flex-col items-center">
              ...
              <button
                disabled={loading}
                onClick={analyze}
                className="flex w-full max-w-xl items-center justify-center gap-3 rounded-2xl bg-gradient-to-r from-[#c9a84c] to-[#8b6914] px-8 py-5 text-2xl font-black text-black shadow-[0_0_40px_rgba(201,168,76,0.35)] transition-all hover:scale-[1.01] hover:opacity-95 disabled:opacity-50"
              >
